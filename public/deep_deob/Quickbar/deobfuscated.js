...
class Quickbar {
  ...
  registerItems() {
    ...
    for (let _0xa19809 in this.items) {
      ...
      _0x250c36.dataset.isChildren = this.items[_0xa19809]?.children || false;
  ...
  loadGifsInList(_0x3daec1) {
    if (_0x3daec1) {
      for (let _0x3da6c2 = 0; _0x3da6c2 < _0x3daec1?.data?.length; _0x3da6c2++) {
        let _0x5b7522 = this.getGiphyImageKey(true);
  ...
  appendToGifList(_0x25ff2c, _0x4b3122 = false, _0x160216 = null, _0x24a1b8 = false, _0x79f5cd = false) {
    ...
    let _0x388de8 = btoa(_0x25ff2c.id + "_" + _0x25ff2c.width + "_" + _0x25ff2c.height + "_" + (_0x24a1b8 ?? false));
    if (_0x24a1b8) {
    ...
    if (_0x37e223) {
      ...
      if (_0x24a1b8) {
        ...
        _0xbfaac8.gifs[_0x388de8].loaded = false;
        _0xbfaac8.gifs[_0x388de8].src = _0x2a6ba6;
        _0xbfaac8.gifs[_0x388de8].message = _0x24a1b8 ?? false;
  ...
  updateChatDelIcon(_0x3a30db) {
    const _0x4f0d5d = findNodeInWindowOrParent(".chatdel .svgBack", true);
    if (_0x4f0d5d) {
  ...
  doGroupsPowers(_0x31e875, _0x1a4759) {
    ...
    this.toggleSideBar(false);
    return this.setGroupsPowers(false, _0x3dcdd6);
  }
  setGroupsPowers(_0x2f75bb, _0x2086cc) {
    ...
    customModalWithMsg(["mob2.grouppowersmanager", "Group powers manager"], "", true, false, true);
    ...
    if (_0x4946e0) {
      ...
      for (let _0x1c1b30 in this.cachedGroupsPowers) {
        try {
          ...
          _0x29ffa8.dataset.isPowerRow = true;
