...
function _ixatWS(url, protocols) {
...
class Activity {
  constructor() {
    ...
    this.LoadModules();
    this.ConnectToC();
    document.addEventListener("click", this.ClickOnDom.bind(this), true);
    ...
    for (let _0x34e541 = 0; _0x34e541 < _0x68482f.length; _0x34e541++) {
      if (_0x68482f[_0x34e541].charAt(0) == "{") {
        ...
        try {
          ...
          console.error("[DoFifoNotification] eval error:", _0x2eebf9, _0x68482f[_0x34e541].toString().substring(0, 200));
        }
      }
    }
  }
  ...
  ProcessDataFromC(_0x5290eb, _0x525c97, _0x23cd7f) {
    ...
    switch (this.xInt(_0x5290eb)) {
      ...
      case this.LOADURL:
        ...
        if (_0x23cd7f) {
          _0x975916.open("POST", _0x2798c3, true);
          ...
          _0x975916.open("GET", _0x2798c3, true);
          _0x975916.send();
        }
        break;
      case this.SEND:
  ...
  HandleFlix(_0x36ec74) {
    return !!this.IsFlixActive && ((_0x36ec74 = _0x36ec74.split("_")).length > 1 ? (this.SetFlixVisible(false), false) : this.FlixChatId !== _0x36ec74[0] && _0x36ec74[0] !== "10" || !this.CanUseFlix() ? (this.DestroyFlix(), false) : (this.SetFlixVisible(true), WakeFlixBackground(), true));
  }
