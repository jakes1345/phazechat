...
class SettingsPage {
  constructor() {
    ...
    this.SettingsAlreadyBinded = false;
  ...
  setSettings(_0x4f63fb) {
    ...
    this.SettingsAlreadyBinded = true;
  ...
  addMacrosTable() {
    ...
    addText(makeElement(_0xf6b4bb, "th"), "&nbsp;", true);
  ...
  initPowersSetting() {
    ...
    if (_Activity.instance.UserSettings?.sticker) {
      this.sticker.value = _Activity.instance.UserSettings.sticker;
    }
  ...
  initPstyleSetting() {
    ...
    this.pstyle.addEventListener("keyup", _0x1cec1f => {
      this.pickrSet(this.pstyle, this.pstyle.value, true);
    });
    if (!hasPower(672)) {
  ...
  autoColor(_0x589baa) {
    _0x589baa.addEventListener("keyup", _0x20a0f3 => {
      this.pickrSet(_0x589baa, _0x589baa.value, true);
    });
  }
  initAvatarSetting() {
...
class Sortable {
  constructor(_0xbdebbf, _0x16f3ed, _0x915cdb, _0x40a2b2, _0x30f139) {
    ...
    window.addEventListener("touchstart", this._onPressTouch.bind(this), false);
    window.addEventListener("touchmove", this._onMove.bind(this), false);
    window.addEventListener("touchend", this._onRelease.bind(this), false);
  }
  getPoint(_0x4ad1f0) {
    let _0x1a4a5f = null;
    let _0x195156 = null;
