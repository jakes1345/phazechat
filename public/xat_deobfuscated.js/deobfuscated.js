...
let appFromUrl = null;
function xatMain(_0x133e3f) {
  var _0x39e702 = JSON.parse(_0x133e3f);
  config = defconfig;
  setdarkmode();
  for (var _0x35dacf in _0x39e702) {
    config[_0x35dacf] = _0x39e702[_0x35dacf];
  }
  if (_0x39e702.MyId !== undefined) {
    _Activity.instance.MyId = xInt(_0x39e702.MyId);
  }
...
function loadQuickBar(_0xaac46d) {
  if (typeof _Activity.instance.QuickBar != "object" || !_Activity.instance.IsClassic || _0xaac46d) {
    try {
      _Activity.instance.QuickBar = new Quickbar();
      _Activity.instance.QuickBar.init(_0xaac46d);
    } catch (_0x3483be) {}
  }
}
function SetPow() {
