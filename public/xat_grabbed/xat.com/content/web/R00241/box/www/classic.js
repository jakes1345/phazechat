...
var chats = new function () {
  ...
  this.addChat = function (_0x5a84a5, _0x3afd0e) {
    ...
    if (_0xb86a85.indexOf("xat.com/") == -1) {
      _0xb86a85 = _0xb86a85.replace(/_/gi, " ");
    }
    _0xb86a85 = _0xb86a85.replace("xat.com/", "");
    ...
    if (!_0xbdf80e || _0x4a112f && _0x4a112f !== lastGroup) {
      if (!(_0xbdf80e = addChatTab(0, _0x2dc939.id, _0x170b20, _0xb86a85, _0x2dc939.CurrentChat == _0x170b20, !1, !_0x4a112f, _0xbdf80e, _0x4a112f))) {
        return;
      }
      if (_0x141df6) {
        _0xbdf80e.NoName = 1;
...
function lightChat(_0x1eefc8, _0xf25777, _0x55b1b4) {
  ...
  for (; _0x3b5cb2 < _0x204c14.length; _0x3b5cb2++) {
    if ((_0x1ab756 = _0x204c14[_0x3b5cb2]).id == _0x1eefc8) {
      ...
      if (!1 === _0x1ab756.active || !0 !== _0xf25777) {
        continue;
      }
      addChatTab(0, 0, _0x1ab756.id, _0x1ab756.chatName, !1, _0x1ab756.lit, _0x1ab756.del, _0x1ab756);
    }
  }
}
...
function getAChatBoxPressed() {
  ...
  window.open("//xat.com/chats" + _0x1ed6fd, "_blank");
}
function smiliePressed(_0x163147) {
  if (typeof messages != "undefined" && messages.activeEditMessageNode) {
    ...
    insertTextAtCaret(_0x163147, messages.activeEditMessageNode, !0);
  } else {
...
function pasteHtmlAtCaret(_0x29bfe9) {
  if (!document.execCommand("insertText", !1, _0x29bfe9) && typeof textEntry.setRangeText == "function") {
...
function setXatLogo() {
  ...
  if (isXatBirthday()) {
    ...
    const _0x42271d = "https://xat.com/images/logo/" + _0x1ac791[Math.floor(Math.random() * _0x1ac791.length)] + ".png";
    if (_0x68fa3f) {
...
this.setScroller = function (_0x4e523f) {
  ...
  for (let _0x11adb6 = 0; _0x11adb6 < _0x275443.length; _0x11adb6++) {
    let _0x223806 = WordIsLink(_0x275443[_0x11adb6], undefined, !0);
    if (_0x223806) {
