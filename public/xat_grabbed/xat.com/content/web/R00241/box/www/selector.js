...
var selector = new function () {
  ...
  this.gotGifts1 = function () {
    let _0x4a6b09;
    let _0x45ec81 = "https://xat.com/web_gear/chat/gifts22.php";
  ...
  function _0x269f1f(_0x168ac6, _0x214804, _0x525fe9) {
    ...
    let _0x10dfc4 = _0x50e951.image("https://xat.com/images/js/gift/" + _0x55012a + ".svg?z1");
    if (_0x214804.f & 2) {
      if (_0x40976d) {
  ...
  function _0x41db24(_0x8d6485, _0x53d5d6, _0x28a867) {
    ...
    _0x51378e.src = "https://gs.xat.com/h_s_" + _0xeacc23 + "_" + (_0x53d5d6[1] ? encodeURIComponent(_0x53d5d6[1]) : "") + ".png";
  ...
  this.doKisses2 = function () {
    ...
    function _0x593d98(_0x254f2c, _0x363053, _0x576d64) {
      ...
      _0x4a639e.width = 83;
      _0x4a639e.height = 60;
      _0x4a639e.src = "https://gs.xat.com/f_ks-t" + _0x254f2c + "_166_120_2_.png";
    ...
    if (this.MarryType) {
      ...
      loadJSON("https://xat.com/web_gear/chat/kiss.php", function (_0x27d33b) {
          ...
          _0x6834fc.onload = function (_0x28c2d9) {
            ...
            for (let _0x4c56ff = 0; _0x4c56ff < _0x25463a.length; ++_0x4c56ff) {
              ...
              if (_0x400a9b[_0x12a54f]) {
                ...
                _0x12a54f = "url('https://xat.com/images/smw/" + _0x12a54f + ".png')";
    ...
    if (_0x37c943 == "end") {
      switch (_0x44d9f5) {
        ...
        case "Gifts":
          ...
          break;
        case "BuyGifts":
          loadJSON("https://xat.com/web_gear/chat/gift2.php?v2=1", _0x51ff75);
          if (navigator.userAgent.indexOf("Firefox") > 0) {
            document.querySelector(".powersScroll").style.height = "88%";
          }
      }
