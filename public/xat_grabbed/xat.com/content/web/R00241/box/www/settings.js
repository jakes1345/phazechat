...
class SettingsPage {
  constructor() {
    ...
    let _0x1a2f3f = "https://xat.com/web_gear/chat/av/" + Math.floor(Math.random() * 1758 + 1) + ".png";
    try {
  ...
  initAccount() {
    ...
    _0x52f771.addEventListener("click", function (_0x42d864) {
      ...
      }
      {
        ...
        urlPost("https://xat.com/web_gear/chat/register5.php", _0x49f737).then(function (_0xd42324) {
          _0x4ea74a.classList.remove("d-none");
          document.querySelector("#accDesc").scrollIntoView({
            behavior: "smooth",
            block: "start"
