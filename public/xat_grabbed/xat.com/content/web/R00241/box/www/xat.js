...
function HitWiki(_0x9dd69f, _0x329177) {
  HitWeb("https://util.xat.com/wiki/index.php?title=" + _0x9dd69f, _0x329177);
}
function LinkValidator(_0x122335, _0x406d72, _0x41111a) {
  ...
  if (_Activity.instance.UserSettings?.linkvalidator == "disable" && ["^", "@", "%"].indexOf(_0x406d72.charAt(0)) == -1 || ["xat.com", "xat.wiki", "forum.xat.com"].includes(_0x145115.host)) {
    if (_0x41111a) {
      return _0x406d72;
    } else {
      HitWeb(_0x406d72);
...
function setAppIcon(_0x321aec) {
  ...
  parent.parent.parent.postMessage(JSON.stringify(_0x430979), "https://xat.com");
}
...
function openApp(_0x381566) {
  ...
  if (parent) {
    parent.postMessage(JSON.stringify(_0x4bc45d), "https://xat.com");
  }
}
      ...
      if (keywords.hasOwnProperty(_0x6bcaed) && !_0x375a13) {
        switch (_0x85fe65 = xInt(_0x2d0ea7 = keywords[_0x6bcaed])) {
          ...
          default:
            ...
            if (_0x85fe65 < 1) {
              return "https://xat.com/" + _0x2d0ea7;
            }
        }
      }
...
function powerAd(_0x269a2e, _0x1951f7) {
  ...
  if (_0xd5efee.length > 0) {
    ...
    document.querySelector("#actionButton").parentNode.addEventListener("click", () => {
      if (Classic) {
        window.open("https://xat.com/" + (_0x1951f7 == 700 ? "aces" : "store"), "_blank");
      } else {
        ToC({
          Command: "StartStore",
          Power: _0x1951f7
...
function doSound(_0x29689c, _0x15f2ce) {
  let _0x1c344a = _0x15f2ce && !_Activity?.instance?.IsIOSApp && Browser != "SF" ? "https://xat.com/content/sounds/audies/" + _0x29689c + ".webm" : "https://xat.com/web_gear/chat/snd/" + _0x29689c + ".mp3";
...
function reportsDrop(_0xa9c6a0 = null) {
  ...
  if (_0x160771) {
    ...
    _0x2fde9a.setAttribute("href", "https://xat.com/report#!user&UserName=" + _0xa9c6a0.split(" ")[0].toLowerCase());
  } else {
...
function openBuyPage(_0x20279f, _0x53b907) {
  ...
  let _0x524142 = "https://xat.com/buy";
  let _0x2be5c7 = {};
  try {
...
function iMux(_0x462708, _0x33429b) {
  ...
  return "https://" + _0x33429b + (_0x41ab02 & 1) + ".xat.com/web_gear/chat/" + _0x462708;
}
var Trusted;
var syel;
var soth;
...
function SafeImage(_0x4b3d64, _0x2f158c, _0x4c189f, _0x174d34) {
  ...
  if (_0x1aec41.host.indexOf("xat.com") >= 0 && (_0x1aec41.path.indexOf("GetImage") > 0 || _0x1aec41.path.indexOf("/chat/av/") >= 0)) {
    return _0x4b3d64;
  }
  ...
  return "https://i0.xat.com/web_gear/chat/GetImage7.php?" + _0x23e11b;
}
...
function handleLiveApp(_0x3a912f = false, _0x418bf2 = false) {
  ...
  if (_0x3c7eee) {
    ...
    const _0xa9e26 = "https://xat.com" + _0x48960a;
...
function livePlayAudio(_0x187a76) {
  ...
  const _0x2704cc = "https://xat.com" + _0x56c40b;
  try {
...
function getAvatarFrameUrl(_0x4b45c4) {
  return "https://i0.xat.com/images/avframes/" + _0x4b45c4 + ".webp";
}
function getAvatarEffectUrl(_0x56a42e, _0x18b537, _0x65d8ef) {
  return "https://i0.xat.com/web_gear/chat/avatareffects.php?e=" + _0x56a42e + "&f=" + (_0x65d8ef !== undefined ? _0x65d8ef : 15) + "&c=" + (_0x18b537 || "").replace("#", "");
}
...
function handleAgeVerification() {
  ...
  document.querySelector(".ageProceed").onclick = function () {
    modalClose();
    window.open("https://xat.com/web_gear/chat/ageverify.php", "_blank");
  };
