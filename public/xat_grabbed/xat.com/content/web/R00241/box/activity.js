...
class Activity {
      ...
      if (_0x68482f[_0x34e541].charAt(0) == "{") {
        ...
        switch (_0x68d46e.Command) {
          ...
          case "PlaySound":
            ...
            const _0x35f2d5 = "https://xat.com/content/sounds/" + _0x68d46e.Sound;
            try {
              new Howl({
  ...
  ConnectToC() {
    if (this.UseWsCore) {
      const _0x2afa04 = "ws://tst763459.xat.com:8081";
      this.WsCore = new WebSocket(_0x2afa04);
      this.WsCore.onopen = () => {
        console.log("WSCORE: Connection opened");
        this.StartChat();
      };
      this.WsCore.onmessage = _0x5a2a15 => {
        const _0x1fc99d = _0x5a2a15.data.match(/:(.*?):(.*)/);
        switch (_0x1fc99d[1]) {
          case "getUserno":
            break;
          case "xatInit":
            this.MyId = _0x1fc99d[2];
            this.Init();
            break;
          case "getStuff":
            this.GetStuff(_0x1fc99d[2]);
            break;
          case "ConsoleOff":
            this.ConsoleOff = _0x1fc99d[2] == "1";
            break;
          case "SetPage":
            this.SetPage(_0x1fc99d[2]);
            break;
          case "ReadToJavaFifo":
          case "xatTick":
            this.GotJsonFromC(_0x1fc99d[2]);
        }
      };
      this.WsCore.onclose = () => {
      ...
      this.LoadJsModule("xatcorewasm.php", 1).then(_0x4079a6 => {}, _0x73282c => {
