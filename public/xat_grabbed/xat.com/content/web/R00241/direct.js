...
function DoSendMessage(_0x5c2e74) {
  ...
  bodyCursor("wait");
  urlPost("https://xat.com/web_gear/chat/ownerfeedback2.php", filter(_0x1186eb)).then(function (_0x428ab5) {
    bodyCursor("default");
    allErrsOff();
  ...
  return new Promise((_0x2b01eb, _0x317698) => {
    if (xConfig.debugJsonGroup) {
      ...
      if (xConfig.debugFetchGroup) {
        let _0x1a70af;
        let _0x3d7526 = "https://xat.com/web_gear/chat/roomid.php?d=" + xConfig.gn;
            ...
            if (!Home) {
              if (_0x18da4f && _0x18da4f >= 1) {
                ...
                if (_0x3481e6 && _0xd16b0c) {
                  ...
                  _0xd16b0c.src = _0x3481e6 == "xat" ? "https://xat.com/images/smw/flag.png" : "https://xat.com/images/smw/flag/" + filter(_0x3481e6) + ".png";
                  _0xd16b0c.onerror = () => {
                    _0xd16b0c.removeAttribute("src");
                    _0xd16b0c.classList.add("d-none");
                  };
                  _0xd16b0c.onload = () => {
                    if (_0x3481e6 !== "xat" && _0xd16b0c.src.substr(0, 32) != "https://xat.com/images/smw/flag/") {
                      _0xd16b0c.removeAttribute("src");
                      _0xd16b0c.classList.add("d-none");
                    }
                  };
...
function updatePage() {
  ...
  if (Home) {
    document.querySelector("meta[name=\"description\"]").setAttribute("content", "xat.com is a fun social networking site, join a group, make friends, create your own xat group");
    document.title = "xat";
  }
...
function pupdate() {
  if (xConfig.lang && xConfig.loadlist) {
    let _0xc3dc5e = "https://xat.com/json/lists/";
