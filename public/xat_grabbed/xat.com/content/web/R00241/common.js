...
function setLoggedin() {
  if (xConfig.username) {
    ...
    let _0x5bc0bc = document.getElementById("navLogin");
    _0x5bc0bc.href = "/login";
    _0x5bc0bc.removeAttribute("data-toggle");
    _0x5bc0bc.removeAttribute("data-target");
    _0x5bc0bc.addEventListener("click", function () {
      window.location.href = "https://xat.com/login";
    });
  }
}
function readUser() {
...
function fetchPromo(_0x56d81e) {
  return new Promise((_0x1d8311, _0x1abc74) => {
    ...
    fetch("https://xat.com/json/promo.php?c=" + _0x3200f9.cb60).then(function (_0x49eb71) {
      ...
      for (let _0x4bd766 in _0x2d12cd) {
        _0x128c37 += "<a class=\"dropdown-item\" href=\"https://xat.com/" + _0x2d12cd[_0x4bd766].n + "\"><img class=\"mr-2\" src=\"" + xConfig.dir + "img/navbar/promoted.svg\" alt=\"promoted\">" + _0x2d12cd[_0x4bd766].n + "</a>";
      }
      if (_0x128c37 !== "") {
...
function localize(_0xe3db2b) {
  if (xConfig.lang.substr(0, 2) != "en") {
    ...
    for (let _0x3fce4c in lf) {
      const _0x3edff3 = "//xat.com/json/translate";
      const _0x3e081a = "php";
...
function legacyLinks() {
  ...
  if (document.querySelector("#navTop")) {
    _0xafbadc = document.getElementById("navCreate");
    _0xafbadc.href = "https://xat.com/chats#!creategroup";
    _0xafbadc.target = "_blank";
    _0xafbadc.removeAttribute("data-toggle");
    _0xafbadc.removeAttribute("data-target");
    _0xafbadc = document.getElementById("navGroupsFeatured");
    _0xafbadc.href = "https://xat.com/#featured";
    _0xafbadc.removeAttribute("data-toggle");
    _0xafbadc.removeAttribute("data-target");
    _0xafbadc = document.getElementById("navGroupsPopular");
    _0xafbadc.href = "https://xat.com/#popular";
    _0xafbadc.removeAttribute("data-toggle");
    _0xafbadc.removeAttribute("data-target");
    _0xafbadc = document.getElementById("navGroupsSupported");
    _0xafbadc.href = "https://xat.com/#supported";
    _0xafbadc.removeAttribute("data-toggle");
    _0xafbadc.removeAttribute("data-target");
    _0xafbadc = document.getElementById("navGroupsGames");
    _0xafbadc.href = "https://xat.com/#games";
    _0xafbadc.removeAttribute("data-toggle");
    _0xafbadc.removeAttribute("data-target");
    _0xafbadc = document.getElementById("navGroupsSearch");
    _0xafbadc.href = "https://xat.com/search";
    _0xafbadc.removeAttribute("data-toggle");
    _0xafbadc.removeAttribute("data-target");
    _0xafbadc = document.getElementById("navGroupsHelp");
    _0xafbadc.href = "https://xat.com/_help";
    _0xafbadc.removeAttribute("data-toggle");
    _0xafbadc.removeAttribute("data-target");
    _0xafbadc = document.getElementById("navGroupsTrade");
    _0xafbadc.href = "https://xat.com/_trade";
    _0xafbadc.removeAttribute("data-toggle");
    _0xafbadc.removeAttribute("data-target");
    _0xafbadc = document.getElementById("navStoreBuyXats");
    _0xafbadc.href = "https://xat.com/buy";
    _0xafbadc.removeAttribute("data-toggle");
    _0xafbadc.removeAttribute("data-target");
    _0xafbadc = document.getElementById("navStorePowers");
    _0xafbadc.href = "https://xat.com/powers";
    _0xafbadc.removeAttribute("data-toggle");
    _0xafbadc.removeAttribute("data-target");
    _0xafbadc = document.getElementById("navStoreAces");
    _0xafbadc.href = "https://xat.com/aces";
    _0xafbadc.removeAttribute("data-toggle");
    _0xafbadc.removeAttribute("data-target");
    _0xafbadc = document.getElementById("navStoreShortName");
    _0xafbadc.href = "https://xat.com/shortname";
    _0xafbadc.removeAttribute("data-toggle");
    _0xafbadc.removeAttribute("data-target");
    _0xafbadc = document.getElementById("navStoreAuctions");
    _0xafbadc.href = "https://xat.com/auction";
    _0xafbadc.removeAttribute("data-toggle");
    _0xafbadc.removeAttribute("data-target");
    _0xafbadc = document.getElementById("navStorePromotion");
    _0xafbadc.href = "https://xat.com/promotion";
    _0xafbadc.removeAttribute("data-toggle");
    _0xafbadc.removeAttribute("data-target");
    _0xafbadc = document.getElementById("navStoreAds");
    _0xafbadc.href = "https://xat.com/ad";
    _0xafbadc.removeAttribute("data-toggle");
    _0xafbadc.removeAttribute("data-target");
    _0xafbadc = document.getElementById("navStoreBuyGroup");
    _0xafbadc.href = "https://xat.com/buygroup";
    _0xafbadc.removeAttribute("data-toggle");
    _0xafbadc.removeAttribute("data-target");
    _0xafbadc = document.getElementById("navxatTerms");
    _0xafbadc.href = "https://xat.com/terms";
    _0xafbadc.removeAttribute("data-toggle");
    _0xafbadc.removeAttribute("data-target");
    if (xConfig.gid && xConfig.gn) {
      _0xafbadc = document.getElementById("navGroupEvents");
      _0xafbadc.href = "https://xat.com/chats#!events&roomid=" + xConfig.gid + "&GroupName=" + xConfig.gn;
      _0xafbadc.target = "_blank";
      _0xafbadc.removeAttribute("data-toggle");
      _0xafbadc.removeAttribute("data-target");
      _0xafbadc = document.getElementById("navCustomize");
      _0xafbadc.href = "https://xat.com/chats#!editgroup&roomid=" + xConfig.gid + "&GroupName=" + xConfig.gn;
      _0xafbadc.target = "_blank";
      _0xafbadc.removeAttribute("data-toggle");
      _0xafbadc.removeAttribute("data-target");
    }
    if (xConfig.gn) {
      _0xafbadc = document.getElementById("navInapp");
      _0xafbadc.href = "https://xat.com/report#!group&GroupName=" + xConfig.gn;
      _0xafbadc.removeAttribute("data-toggle");
      _0xafbadc.removeAttribute("data-target");
      _0xafbadc.target = "_blank";
    }
    _0xafbadc = document.getElementById("navAccountedit");
    _0xafbadc.href = "https://xat.com/editme#" + xConfig.username;
    _0xafbadc.removeAttribute("data-toggle");
    _0xafbadc.removeAttribute("data-target");
    _0xafbadc = document.getElementById("navAccountxatme");
    _0xafbadc.href = "https://xat.me/" + xConfig.username;
    _0xafbadc.removeAttribute("data-toggle");
    _0xafbadc.removeAttribute("data-target");
    _0xafbadc = document.getElementById("navLogout");
    _0xafbadc.href = "https://xat.com/logout";
    _0xafbadc = document.getElementById("navSettings");
    _0xafbadc.href = "https://xat.com/login";
  }
}
function navClickHandlers() {
  ...
  document.getElementById("openPolicy").addEventListener("click", function () {
    window.open("https://xat.com/privacy", "_blank");
  });
...
function initAuser3() {
  let _0x3c828b = "//xat.com/login?mode=1&";
...
function setLogo() {
  ...
  if (_0x468dd0) {
    ...
    if (_0x3c0979.length) {
      const _0x174810 = "https://xat.com/images/logo/" + _0x3c0979[Math.floor(Math.random() * _0x3c0979.length)] + ".png";
...
function getEmbed(_0x21538c, _0x98c72e, _0x4090d1, _0xa570ba, _0x2d5daa, _0x27b10f) {
  let _0x33fc01 = "<iframe src=\"https://xat.com/embed/chat.php#id=%CHAT_ID%&gn=%CHAT_NAME%\" allow=\"clipboard-write\" width=\"%CHAT_WIDTH%\" height=\"%CHAT_HEIGHT%\" frameborder=\"0\" scrolling=\"no\"></iframe>";
  _0x33fc01 += "<br><small><a target=\"_BLANK\" href=\"https://xat.com/web_gear/chat/embed.php?id=%CHAT_ID%&GroupName=%CHAT_NAME%\">Get %CHAT_NAME% chat group</a> | ";
  _0x33fc01 += "<a target=\"_BLANK\" href=\"https://xat.com/%CHAT_NAME%\"> Go to %CHAT_NAME% website</a></small><br>";
...
function SafeImage(_0xd62a74, _0x306e51, _0x5a4984, _0x453b50) {
  ...
  if (_0x25170c.host.indexOf("xat.com") >= 0 && (_0x25170c.path.indexOf("GetImage") > 0 || _0x25170c.path.indexOf("/chat/av/") >= 0)) {
    return _0xd62a74;
  }
  ...
  return "https://i0.xat.com/web_gear/chat/GetImage7.php?" + _0x164a4e;
}
...
function Maintenance(_0x2e43db) {
  if (_0x2e43db.Err && _0x2e43db.Err.Maintenance) {
    window.location.href = "https://xat.com/maintenance";
  }
}
  ...
  if (localStorage.getItem("hideBlackBar") !== "true") {
    ...
    document.addEventListener("click", function (_0x2a8ca3) {
      if (_0x2a8ca3.target.closest(".close-button") !== null) {
        ...
        window.open("https://xat.com/buy", "_blank");
      }
    });
  }
}
